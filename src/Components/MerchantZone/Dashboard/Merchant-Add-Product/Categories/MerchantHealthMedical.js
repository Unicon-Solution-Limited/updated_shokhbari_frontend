        ...
        <div className="row my-4">
          ...
          <div className="col-md-3">
            ...
            <div>
              ...
              >
                {/* Personal Care */}
                {selectOption === "PersonalCareSafety" && (
                  <>
                    <option value="PersonalCareSafety">
                      Personal Care & Safety
                    </option>
                ...
                {/* Medical supplies */}
                {selectOption === "Medical_Supplies" && (
                  <>
                    <option value="Medicines">Medicines</option>
                    <option value="Ointment_Creams">Ointment & creams</option>
                    <option value="Health_Monitors">
                      Health Monitors & Tests
                    </option>
                    <option value="Health_Acessories">
                      Health Accessories
                    </option>
                    <option value="First_Aid_Supplies">
                      First Aid Supplies
                    </option>
                  </>
                )}
                ...
                {/* food supplements */}
                {selectOption === "Food_Supplements" && (
                  <>
                    <option value="Beauty_Supplements">
                      Beauty Supplements
                    </option>
...
export default MerchantHealthMedical;
