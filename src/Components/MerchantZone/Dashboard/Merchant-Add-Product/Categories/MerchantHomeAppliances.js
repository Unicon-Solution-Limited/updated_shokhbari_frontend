            ...
            <div className="row my-4">
              ...
              <div className="col-md-3">
                ...
                <div>
                  ...
                  >
                    ...
                    {selectOption === "Iron and Garment steamers" && (
                      <>
                        <option value="Iron_and_Garment_steamers">
                    ...
                    {selectOption === "Home lighting" && (
                      <>
                        ...
                        <option value="Plugs and Outlets">
                          Plugs & Outlets
                        </option>
                      </>
                    )}
                    ...
                    {selectOption === "Others Appliances" && (
                      <>
                        <option value="Others Appliances">
                          Others Appliances
                        </option>
                      </>
                    )}
              ...
              <div className="col-md-3">
                ...
                <div>
                  ...
                  >
                    <option value="none">Choose a Sub Child Categories</option>
                  </select>
                </div>
              </div>
            </div>
...
export default MerchantHomeAppliances;
