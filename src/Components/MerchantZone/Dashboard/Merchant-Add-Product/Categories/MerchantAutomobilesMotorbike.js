...
const MerchantAutomobilesMotorbike = () => {
    ...
    <div className="addProductBody my-2">
      <div className="headline">
        <h3 className="d-flex justify-content-center">
          Add Automobiles & Motorbike Products
        </h3>
        <h5
              ...
              <div className="col-md-3">
                ...
                <div>
                  <select
                    ...
                    required
                  >
                    <option value="Automobile and Motorbike">
              ...
              <div className="col-md-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Automobile_Parts">Automobile Parts</option>
                    <option value="Interior_Accessories_care">
                      Interior Accessories & care
                    </option>
                    <option value="Exterior_Accessories_care">
                      Exterior Accessories & care
                    </option>
                    <option value="Bike">Bike</option>
                    <option value="Bike_Parts_Accessories">
                      Bike Parts Accessories
                    </option>
                    <option value="Oil_Fluids">Oil Fluids</option>
                    <option value="Riders_gear">Riders Gear</option>
                  </select>
                </div>
              </div>
              {/* child categories */}
              <div className="col-md-3">
                ...
                <div>
                  <select
                    ...
                    required
                  >
                    {selectOption === "Automobile" && (
                      <>
                        <option value="Automobile">Automobile</option>
                      </>
                    )}

                    {selectOption === "Automobile_Parts" && (
                      <>
                        <option value="Automobile_Parts">
                          Automobile Parts
                        </option>
                      </>
                    )}

                    {selectOption === "Interior_Accessories_care" && (
                      <>
                        <option value="Interior_Accessories_care">
                          Interior Accessories & Care
                        </option>
                    ...
                    {selectOption === "Exterior_Accessories_care" && (
                      <>
                        <option value="Exterior_Accessories_care">
                          Exterior Accessories & Care
                        </option>
                    ...
                    {selectOption === "Bike_Parts_Accessories" && (
                      <>
                        <option value="Bike_Parts_Motorbike">Motorbike</option>
                        <option value="Bike_Parts_Bicycle">Bicycle</option>
                      </>
                    )}

                    {selectOption === "Oil_Fluids" && (
                      <>
                        <option value="Oil_Fluids">Oil Fluids</option>
                      </>
                    )}

                    {selectOption === "Riders_gear" && (
                      <>
                        <option value="Riders_gear">Riders & Gear</option>
                      </>
                    )}
...
export default MerchantAutomobilesMotorbike;
