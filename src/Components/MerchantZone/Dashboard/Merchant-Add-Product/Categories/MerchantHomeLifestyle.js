              ...
              <div className="col-md-3">
                ...
                <div>
                  <select
                    ...
                    required
                  >
                    <option value="Home and Lifestyle">
                      Home and Lifestyle
                    </option>
                  </select>
                </div>
              ...
              <div className="col-md-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Kitchen_Accessories">
                      Kitchen Accessories
                    </option>
                    <option value="Decor">Decor</option>
                    <option value="Wallart">Wallart</option>
                    <option value="Tools_Diy_and_outdoor">
                      Tools Diy and outdoor
                    </option>
                    <option value="EventPartySupplies">
                  ...
                  >
                    ...
                    {selectOption === "Furniture" && (
                      <>
                        ...
                        <option value="Kid's_Room">Kid's Room</option>
                        <option value="Institutional">Institutional</option>
                        <option value="Office">Office</option>
                        <option value="Door">Door</option>
                        <option value="Storage_Organization">
                          Storage Organization
                        </option>
                      </>
                    )}

                    {selectOption === "Home_Textile" && (
                      <>
                        <option value="Home_Textile">Home Textile</option>
                      </>
                    )}

                    {selectOption === "DinnerWare" && (
                      <>
                        <option value="DinnerWare">DinnerWare</option>
                      </>
                    )}

                    {selectOption === "Kitchen_Accessories" && (
                      <>
                        <option value="Kitchen_Accessories">
                          Kitchen Accessories
                        </option>
                    ...
                    {selectOption === "Wallart" && (
                      <>
                        <option value="Wallart">Wallart</option>
                      </>
                    )}

                    {selectOption === "Tools_Diy_and_outdoor" && (
                      <>
                        <option value="Tools_Diy_and_outdoor">
                          Tools Diy and outdoor
                        </option>
                    ...
                    {selectOption === "EventPartySupplies" && (
                      <>
                        <option value="EventPartySupplies">
                          EventPartySupplies
                        </option>
...
export default MerchantHomeLifestyle;
