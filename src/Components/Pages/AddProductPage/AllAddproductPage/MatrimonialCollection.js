          ...
          <div className="col-md-3">
            ...
            <div>
              <select
                ...
                required
              >
                <option value="Matrimonial Collection">
          ...
          <div className="col-md-3">
            ...
            <div>
              ...
              >
                ...
                <option value="Wedding_Dress_Collection">
                  Wedding Dress Collection
                </option>
                <option value="Wedding_Jewelry_Collection">
                  Wedding Jewelry Collection
                </option>
                <option value="Wedding_Footwear">Wedding Footwear</option>
                <option value="Wedding_Accessories">Wedding Accessories</option>
                <option value="Beauty_Park">Beauty Park</option>
                <option value="Wedding_Vehicle">Wedding Vehicle</option>
                <option value="Cinemafogrophy_Photography">
          ...
          <div className="col-md-3">
            ...
            <div>
              <select
                ...
                required
              >
                {selectOption === "Wedding_Planner" && (
                  <>
                    <option value="Wedding_Planner">Wedding Planner</option>
                  </>
                )}

                {selectOption === "Wedding_Dress_Collection" && (
                  <>
                    <option value="Wedding_Dress_Collection">
                      Wedding Dress Collection
                    </option>
                ...
                {selectOption === "Wedding_Jewelry_Collection" && (
                  <>
                    <option value="Wedding_Jewelry_Collection">
                      Wedding Jewelry Collection
                    </option>
                ...
                {selectOption === "Wedding_Footwear" && (
                  <>
                    <option value="Wedding_Footwear">Wedding Footwear</option>
                  </>
                )}

                {selectOption === "Wedding_Accessories" && (
                  <>
                    <option value="Wedding_Accessories">
                      Wedding Accessories
                    </option>
                  </>
                )}

                {selectOption === "Beauty_Park" && (
                  <>
                    <option value="Beauty_Park">Beauty Park</option>
                  </>
                )}

                {selectOption === "Wedding_Vehicle" && (
                  <>
                    <option value="Wedding_Vehicle">Wedding Vehicle</option>
                  </>
                )}

                {selectOption === "Cinemafogrophy_Photography" && (
                  <>
                    <option value="Cinemafogrophy_Photography">
                      Cinemafogrophy Photography
                    </option>
                ...
                {selectOption === "Wedding_Venue" && (
                  <>
                    <option value="Wedding_Venue">Wedding Venue</option>
                  </>
                )}

                {selectOption === "Catering_Service" && (
                  <>
                    <option value="Catering_Service">Catering Service</option>
                  </>
                )}

                {selectOption === "Sound_System" && (
                  <>
                    <option value="Sound_System">Sound System</option>
                  </>
                )}
...
export default MatrimonialCollection;
