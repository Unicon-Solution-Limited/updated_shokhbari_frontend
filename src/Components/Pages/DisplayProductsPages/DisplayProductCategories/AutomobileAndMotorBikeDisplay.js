...
const AutomobileAndMotorBikeDisplay = () => {
  ...
  useEffect(() => {
    ...
    setOfficeEducationActiveTab(storedTab || "#-tab"); // Setting default active tab
  }, []);
      ...
      <div className="d-flex align-items-start categoryDisplay">
        ...
        >
          ...
          <button
            ...
            aria-controls=""
            aria-selected={
              officeEducationActiveTab === "#-tab" ? "true" : "false"
            }
            className={`nav-link categoryButton ${
              officeEducationActiveTab === "#-tab" ? "active" : ""
            }`}
        ...
        >
          ...
          <div
            ...
            className={`tab-pane fade ${
              officeEducationActiveTab === "#-tab" ? "show active" : ""
            }`}
          >
