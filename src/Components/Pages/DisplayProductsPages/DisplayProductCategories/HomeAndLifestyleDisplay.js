...
const HomeAndLifestyleDisplay = () => {
  ...
  useEffect(() => {
    ...
    setHomeLifeActiveTab(storedTab || "#-tab"); // Setting default active tab
  }, []);
      ...
      <div className="d-flex align-items-start categoryDisplay">
        ...
        >
          ...
          <button
            ...
            role="tab"
            aria-controls=""
            aria-selected={homeLifeActiveTab === "#-tab" ? "true" : "false"}
            className={`nav-link categoryButton ${
              homeLifeActiveTab === "#-tab" ? "active" : ""
            }`}
        ...
        >
          ...
          <div
            ...
            className={`tab-pane fade ${
              homeLifeActiveTab === "#-tab" ? "show active" : ""
            }`}
          >
