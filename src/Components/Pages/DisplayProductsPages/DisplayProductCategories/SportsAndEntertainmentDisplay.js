...
const SportsAndEntertainmentDisplay = () => {
  ...
  useEffect(() => {
    ...
    setSportsActiveTab(storedTab || "#-tab"); // Setting default active tab
  }, []);
      ...
      <div className="d-flex align-items-start categoryDisplay">
        ...
        >
          ...
          <button
            ...
            role="tab"
            aria-controls=""
            aria-selected={sportsActiveTab === "#-tab" ? "true" : "false"}
            className={`nav-link categoryButton ${
              sportsActiveTab === "#-tab" ? "active" : ""
            }`}
        ...
        >
          ...
          <div
            ...
            className={`tab-pane fade ${
              sportsActiveTab === "#-tab" ? "show active" : ""
            }`}
          >
